...
class IIMSMessage(Interface):
    """ An adapter for the BrowserRequest to handle Heja Sverige IMS messages.
    """

    def sendMessage(title, message, receiver, sender=None, replyTo=None):
        """ Send a Heja Sverige IMS message.
        """

    def replyToMessage(instance, message):
        """ Reply to a Heja Sverige IMS message
        """

    def forwardMessage(instance, message, receiver):
        """ Forward a Heja Sverige IMS message to somebody
        """
